...
<?php echo $this->Form->create('Discussion');?>
	<fieldset>
            <legend class="text-info"><?php echo __('Edit Discussion'); ?></legend>
	<?php
		...
		echo $this->Form->hidden('activity_id', array('value'=>$activity[0]['Activity']['id']));
...
<div class="col-md-10"></div>
      ...
      <?php echo $this->Html->div('col-md-1', $this->Form->postLink('Delete', array('action' => 'delete', $this->Form->value('Discussion.id'), $this->Form->value('Discussion.activity_id')), array('class'=>'form-control btn btn-sm btn-danger'), __('Are you sure you want to delete this discussion?'))); ?>
...
<?php echo $this->Form->create('Discussion');?>
	<fieldset>
		<legend><?php echo __('Edit Discussion'); ?></legend>
	<?php
		echo $this->Form->input('id');
		echo $this->Form->input('title');
		echo $this->Form->input('intro');
		echo $this->Form->input('prompt');
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Discussion.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Discussion.id'))); ?></li>
		<li><?php echo $this->Html->link(__('List Discussions'), array('action' => 'index'));?></li>
		<li><?php echo $this->Html->link(__('List Activities'), array('controller' => 'activities', 'action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Activity'), array('controller' => 'activities', 'action' => 'add')); ?> </li>
		<li><?php echo $this->Html->link(__('List Sections'), array('controller' => 'sections', 'action' => 'index')); ?> </li>
