...
<?php echo $this->Form->create('Step');?>
	...
	<?php
		echo $this->Form->hidden('activity_id', array('value'=>$activities[0]['Activity']['id']));
                echo $this->Html->div('col-md-12 form-group', $this->Form->input('procedureStep', array('class'=>'form-control', 'label'=>'Add Procedure Step')));
	?>
	</fieldset>
        ...
        <div class="panel panel-body">
            ...
            <?php foreach($activities[0]['Step'] as $step):?>
                ...
                <div class="col-md-1">
                    ...
                    <div class="col-md-1">
                    <p class="pull-right"><?php echo $this->Form->postLink('Delete', array('action' => 'delete', $step['id'], $step['activity_id']), array('class'=>'btn btn-danger btn-xs'));?></p>
                </div>
                </div>
            <?php endforeach;?>
            </ol>
...
<?php echo $this->Form->create('Step');?>
	...
	<?php
		echo $this->Form->input('activity_id', array('value'=>$activities[0]['Activity']['id']));
		echo $this->Form->input('procedureStep');
	?>
	</fieldset>
<?php echo $this->Form->end(__('Submit'));?>
</div>
