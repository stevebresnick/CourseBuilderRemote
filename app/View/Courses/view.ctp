...
<?php echo $this->Html->div('col-md-12', $this->Html->link(__('Back to Courses'), array('action' => 'index'), array('class'=>'btn btn-success btn-md btn-block')));?>
...
<div class="controls">
    <ul class="nav default">
                <?php for($i=0;$i<count($course['Section']);$i++){
