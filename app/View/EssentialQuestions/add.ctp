...
<?php echo $this->Form->create('EssentialQuestion');?>
	<fieldset>
            <legend class="text-info"><?php echo __('Add Essential Question for Session '.$sections[0]['Section']['number']);
            echo $this->Html->link('Return to Session '.$sections[0]['Section']['number'], array('controller'=>'sections', 'action'=>'view', $sectionid), array('class'=>'pull-right'));?></legend>
	<?php
